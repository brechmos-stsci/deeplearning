...
# Load the TIFF file
im = Image.open('/Users/crjones/Box/Science/HargisDDRF/Carina/CarinaDisplayMultiple/carina.tiff')
imarr = np.asarray(im)
print(imarr.shape)
...
#tsne = np.load('/Users/crjones/Box/Science/HargisDDRF/Carina/CarinaDisplayMultiple/carina_nopreproc_rotations.npy')[0]
#tsne = np.load('/Users/crjones/Box/Science/HargisDDRF/Carina/CarinaDisplayMultiple/carina_nopreproc_rotations.npy')[0]
tsne = np.load('/Users/crjones/Box/Science/HargisDDRF/Carina/CarinaDisplayMultiple/carina_histeq_rotations.npy')[0]
